                    ...
                    <br>
                        <div class="row">
                            ...
                            <div class="form-group col-md-8">
                                ...
                                <textarea type="text" class="form-control @error('details') {{ 'is-invalid' }}@enderror" id="rich_text_details" name="details" placeholder="Ex. " value="">{{ $place->details }}</textarea>
                                ...
                                <div class="row">   
                                    @foreach ($toas as $toa)
                                        <div class="form-check col-md-1 ml-3">
                                            <input class="form-check-input" type="checkbox" value="{{ $toa->id }}" id="defaultCheck1" name="type_of_attractions[]" {{ (is_array($place->type_of_attractions) && in_array($toa->id, $place->type_of_attractions)) ? ' checked' : '' }}>

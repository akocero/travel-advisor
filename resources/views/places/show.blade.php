                ...
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="pills-personal-info" role="tabpanel" aria-labelledby="pills-personal-info-tab">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                <label for="purok_id">Purok (Optional)</label>
                                <input type="text" class="form-control @error('purok_id') {{ 'is-invalid' }}@enderror" id="purok_id" name="purok_id" placeholder="Type Firstname..." value="{{ $resident->purok->name  }}">

...
@section('content')
    ...
    <div class="modal fade show" id="TOA_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control @error('name') {{ 'is-invalid' }}@enderror"
                                            name="name" id="name" value="{{ old('name') }}" placeholder="Type name..." required>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control @error('details') {{ 'is-invalid' }}@enderror"
                                            ...
                                            @error('details')
                                                <small
                                                    class="text-danger">{{ ' The program/activity/project statement is required' }}</small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" class="form-control @error('name') {{ 'is-invalid' }}@enderror"
                                                        name="name" id="edit_name" value="{{ old('name') }}" placeholder="Type name..."
                                                        required>
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input type="text" class="form-control @error('details') {{ 'is-invalid' }}@enderror"
                                                            name="details" id="edit_details" value="{{ old('details') }}"
                                        ...
                                        <div class="modal-footer pt-0 border-top-0">
                                            ...
                                            <button type="button" id="close_button" class="btn btn-secondary" data-dismiss="modal"
                            ...
                            <div class="container">
                                <div class="card">
                                    <div class="col-12 pt-3 px-3 d-flex justify-content-between align-items-center">
                                        ...
                                        <button type="button" id="open_button" class="btn btn-custom-success" data-toggle="modal"
                                    ...
                                    <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <input type="text" class="form-control" id="search" name="search"
                                                                placeholder="Enter Family Name or Details..." required
                                                                value="{{ $search ? $search : '' }}">
                                                        </div>
                                                    </div>
                                                </form>
                                        ...
                                        <div class="row">
                                            ...
                                            <i class="far fa-trash-alt" ></i>
                                                                    ...
                                                                    <button type="button" onclick="editOrView('edit', {{ $TOA->id }})"
                                                                        class="btn btn-light btn-sm">
                                                                        <i class="far fa-edit"></i>
                                                                    </button>
                                                                    <button type="button" onclick="editOrView('view',{{ $TOA->id }})"
                                                                        class="btn btn-light btn-sm">
